...
#TASK 4 - remove negative words if mentioned twice  & remove proprietary terms

def censor_negative_and_proprietary(text, lst_neg, lst2):
    for word in lst_neg:
        text = text.replace


### task 3 tests - works -- does not work if you change the name at the bottom for other than text. why??
#def censor_multiple_words(text, lst):
   # for word in lst:
     #   censored_word = ""
